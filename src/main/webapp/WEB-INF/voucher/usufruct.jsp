...
ㆍMoviePark 서비스는 국내 및 해외 일부 해외 서비스 대상 국가에서 이용하실 수 있습니다. <br>
...
ㆍTV 사용가능 기기는 MoviePark앱이 설치가 되어 있거나 앱스토어에서 설치가 가능한 스마트TV 및 Android SetTopBox용 OTT이며, TV기기에서는 일부 채널은 LIVE서비스가 제공되지 않습니다.<br>
